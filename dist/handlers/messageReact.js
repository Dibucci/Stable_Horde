...
exports.handleMessageReact = void 0;
const discord_js_1 = require("discord.js");
async function handleMessageReact(reaction, user, client, database, stable_horde_manager) {
    if (!client.config.use_database || !database || !client.config.react_to_transfer?.enabled)
        return;
    if (!client.checkGuildPermissions(reaction.message.guildId, "react_to_transfer"))
        return;
...
exports.handleMessageReact = handleMessageReact;
